...
namespace Blossom
{
	...
	public:
		...
		#define BL_LOG_TRACE(...) Log::LogMessage(Log::Level::Trace, __VA_ARGS__);
		#define BL_LOG_INFO(...) Log::LogMessage(Log::Level::Info, __VA_ARGS__);
		#define BL_LOG_WARN(...) Log::LogMessage(Log::Level::Warn, __VA_ARGS__);
		#define BL_LOG_ERROR(...) Log::LogMessage(Log::Level::Error, __VA_ARGS__);
		#define BL_LOG_FATAL(...) Log::LogMessage(Log::Level::Fatal, __VA_ARGS__);
